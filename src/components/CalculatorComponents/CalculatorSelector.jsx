...
const CalculatorSelector = () => {
  ...
  const calculators = [
    { id: 'loanCredit', title: 'Loan & Credit Cards', calcs: ['Loan Payoff', 'Home Affordability', 'Mortage Refinancing', 'Mortage Acceleration', 'Credit Card Debt', 'Lease Payment', 'Car Affordability'], keys: [1,2,3,4,5,6,7]},
    { id: 'saveInvest', title: 'Saving & Investing', calcs: ['College Funding', 'Saving Goals', 'Savings Accumulation', 'Taxable Equivalent Yield'], keys: [8,9,10,11]},
    { id: 'cashManage', title: 'Cash Management', calcs: ['Cash Flow Management', 'Net Worth', 'Lifetime Earnings'], keys: [12,13,14]},
    { id: 'taxesIRA', title: 'Taxes & IRAS', calcs: ['Federal Incom Tax', ' Tax-Deferred Savings', 'IRA Eligibility', 'Roth IRA Conversion', 'Estate Taxes'], keys: [15,16,17,18,19]}
  ];
