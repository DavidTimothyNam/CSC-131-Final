      ...
      <Layout>
        ...
        <div className="accordion accordion-flush" id="accordionFlushExample">
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                Describe specialized services for tax efficiency and
                comprehensive insurance planning to protect assets
              </div>
            </div>
          </div>
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                Provide workshops, articles, and webinars that empower clients
                with financial literacy and market insights
              </div>
            </div>
          </div>
        </div>
