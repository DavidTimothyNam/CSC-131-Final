...
const ContactForm = () => {
    ...
    const handleChange = (e) => {
        ...
        const key = id.replace("floatingInput", "").replace("floatingSelect", "").toLowerCase();
    ...
    const handleSubmit = () => {
        checkBoxes();
        const isValid = Object.values(inputValidation).every((status) => status === 'is-valid');
        if (!isValid) {
            ...
            <div className="container mt-5" style={{ width: '60%' }}>
              ...
              />
                    ...
                    <div id="the-count" className="mb-3">
                        <span id="current" style={getCharStyle(charCount)}>{charCount}</span>
