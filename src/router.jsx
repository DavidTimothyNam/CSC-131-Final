...
import ResourceCalendar from "./components/Calendar/ResourceCalendar.jsx"; // Resource calendar component
...
export const router = createBrowserRouter([
  ...
  { path: "/calendar", element: <CalendarPage /> }, // Resource Calendar Route
